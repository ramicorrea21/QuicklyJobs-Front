            ...
            <div className="bg-white shadow-xl rounded-lg max-w-4xl w-full mx-auto p-4 mb-8">
                <div className="flex flex-wrap md:flex-nowrap">
                    ...
                    <div className="w-full md:w-1/2">
                        <Image
                            src={request_info?.pictures} // Asegúrate de que esto sea una URL válida
                            alt="Service Image"
                            width={500}
                            height={500}
                    ...
                    <div className="w-full md:w-1/2 p-4 space-y-4">
                        <h2 className="text-3xl font-bold">{request_info.title}</h2>
                        <p className="text-gray-700">{request_info.description}</p>
                        ...
                        <div className="flex items-center text-sm">
                            ...
                            <span>{request_info.city}, {request_info.state}</span>
                        </div>
                        <div className="flex items-center text-sm">
                            <FaLaptop className="text-primary mr-2" />
                            <span>{request_info.remote}</span>
                        </div>
                        <div className="flex items-center text-sm">
                            <FaTag className="text-primary mr-2" />
